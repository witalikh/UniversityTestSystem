...
#nullable disable
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            // Sign in the userEntity with this external login provider if the userEntity already has a login.
            ...
            {
                // If the userEntity does not have an account, then ask the userEntity to create an account.
        ...
        {
            returnUrl = returnUrl ?? this.Url.Content("~/");
            // Get the information about the userEntity from the external login provider
            var info = await this._signInManager.GetExternalLoginInfoAsync();
            if (info == null)
            {
            ...
            if (this.ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        this._logger.LogInformation("UserEntity created an account using {Name} provider.", info.LoginProvider);
        ...
        private IUserEmailStore<UserEntity> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("The default UI requires a userEntity store with email support.");
            }
            return (IUserEmailStore<UserEntity>)this._userStore;
        }
    }
}
