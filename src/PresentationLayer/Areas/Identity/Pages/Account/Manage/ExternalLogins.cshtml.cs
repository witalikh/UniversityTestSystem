...
#nullable disable
    ...
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (this._userStore is IUserPasswordStore<UserEntity> userPasswordStore)
            {
        ...
        public async Task<IActionResult> OnPostLinkLoginAsync(string provider)
        {
            ...
            // Request a redirect to the external login provider to link a login for the current userEntity
